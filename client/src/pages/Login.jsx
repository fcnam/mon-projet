    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-primary-300 text-sm mt-1">Centre de Contrôle Régional - Casablanca</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-1 text-xs text-gray-600">
              <p className="text-center">👤 admin / admin123 (Administrateur)</p>
              <p className="text-center">👤 atsep / atsep123 (Opérateur)</p>
            </div>
          </div>
        </div>
        ...
        <p className="text-center text-primary-200 text-sm mt-8">
          © 2025 CCR Casablanca - Tous droits réservés
        </p>
      </div>
    </div>
  );
